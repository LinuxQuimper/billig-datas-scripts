...
#
outPath=/mnt/datas/repositories/linuxmint/
...
CMD="debmirror --i18n -a $arch --ignore-missing-release --no-source -s $section -h $server -d $release -r $inPath -v --progress --postcleanup -e $proto --ignore-release-gpg $outPath"

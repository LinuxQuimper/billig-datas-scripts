...
#
#release=trusty,trusty-updates,trusty-security,vivid,vivid-updates,vivid-security,wily,wily-updates,wily-security
release=xenial,xenial-updates,xenial-security
...
#
outPath=/mnt/datas/repositories/ubuntu/
#outPath=/mnt/external/repositories-ubuntu/
